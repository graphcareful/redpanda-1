...
public:
    ...
    ss::future<std::vector<topic_result>> create_materialized_topics(
      std::vector<create_materialized_topic_cmd_data>,
      model::timeout_clock::time_point);
...
private:
    ...
    ss::future<topic_result> do_create_materialized_topic(
      create_materialized_topic_cmd_data, model::timeout_clock::time_point);
